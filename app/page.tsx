      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1060px] px-11 py-16 lg:py-[64px]">
          <div className="grid grid-cols-1 gap-10 items-center lg:grid-cols-[1.34fr_0.82fr]">
            {/* Left: text */}
            <div>
              <h1 className="font-heading text-[38px] leading-[1.06] font-semibold tracking-[-0.028em] sm:text-[49px] max-w-[600px] [text-wrap:balance] mb-5">
                Understand the patterns behind health anxiety
              </h1>
              <p className="text-[18px] leading-[1.6] text-text-2 max-w-[520px] mb-8 [text-wrap:pretty]">
        ...
        <div className="mx-auto max-w-[1000px] px-11">
          ...
          <div className="grid grid-cols-1 gap-[22px] sm:grid-cols-3">
            {APPROACH_CARDS.map(({ title, description, icon }) => (
              <div
                key={title}
                className="rounded-[18px] border border-[#E7E2DA] bg-white p-[28px]"
              >
